...
```{r echo=FALSE, message=FALSE, results=FALSE, fig.align="center", out.width = '100%'}
...
```{r echo=FALSE, message=FALSE, results=FALSE, fig.align="center", out.width = '100%', message=FALSE, warning=FALSE}
